    ...
    public class StartUp
    {
        ...
        public static string GetSoldProducts(ProductShopContext context)
        {
            ...
            var users = context.Users
                        .Where(u => u.ProductsSold.Any(p => p.Buyer != null)) // Ensure there's at least one product with a buyer
                        .Select(u => new {
                            u.FirstName,
                            u.LastName,
                            soldProducts = u.ProductsSold
                                             .Where(p => p.Buyer != null) // Filter only products with buyers
                                             .Select(p => new {
                                                 p.Name,
                                                 p.Price,
                        ...
                        .ThenBy(u => u.FirstName) // Then order by first name
                        .ToArray();
