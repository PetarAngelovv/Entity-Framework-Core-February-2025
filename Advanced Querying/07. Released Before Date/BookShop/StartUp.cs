namespace BookShop
{
    ...
    public class StartUp
    {
        ...
        public static string GetBooksReleasedBefore(BookShopContext context, string date)
        {
            ...
            foreach (var b in books)
            {
                sb.AppendLine($"{b.Title} - {b.EditionType.ToString()} - ${b.Price.ToString("F2", CultureInfo.InvariantCulture)}");
            }
        ...
        public static string GetBooksByAuthor(BookShopContext context, string input)
        {
            ...
            return string.Join(Environment.NewLine, books.Select(b => $"{b.Title} ({b.AuthorFullName})")).TrimEnd();
        }
