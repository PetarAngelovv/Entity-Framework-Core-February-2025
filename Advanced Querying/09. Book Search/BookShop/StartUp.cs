namespace BookShop
{
    ...
    public class StartUp
    {
        ...
        public static string GetBookTitlesContaining(BookShopContext context, string input)
        {
            ...
            // Преобразуваме input към малки букви, за да игнорираме големи и малки букви
            string searchTerm = input.ToLowerInvariant();

            var books = context.Books
                .Where(b => b.Title.ToLower().Contains(searchTerm))  // Сравняваме малки букви
                .OrderBy(b => b.Title)  
                .Select(b => b.Title)  
                .ToArray();  
